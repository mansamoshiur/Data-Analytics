        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
            <div className='w-full shadow-xl flex flex-col p-4 my-8 rounded-lg hover:scale-105 duration-300'>
                ...
                <div  className='text-center font-medium'>
                    ...
                    <button className='bg-[#00df9a] w-[200px]  rounded-md my-6 mx-auto py-3 text-black font-semibold '>Start Trial</button>
            </div>
            <div className='w-full shadow-xl flex flex-col bg-gray-100 p-4 md:my-0 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <div  className='text-center font-medium'>
                    ...
                    <button className='text-[#00df9a] w-[200px]  rounded-md my-6 mx-auto py-3 bg-black font-semibold '>Start Trial</button>
            </div>
            <div className='w-full shadow-xl flex flex-col p-4 my-8 rounded-lg hover:scale-105 duration-300'>
